                    ...
                    if (mysqli_num_rows($res) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($res)) {
                            ...
                            <div class='btn'>
                                ...
                                <a href="code.php?removecartid=<?php echo $row['id']; ?>"><span
                                        class='fa fa-trash ml-5 remove'></span></a>
                            </div>
                            <hr>
                            <script>
            ...
            <div class="col-lg-4">
                <div class='card'>
                    ...
                    <div class='ml-3 mr-3'>
                        ...
                        ?>
                        <p style='color:#26a541' id='savemoney'>You will save
                            <?php echo $total_bachat; ?> on this order
